...
?>
                        ...
                        <div id = "loginform">
                            <form method = "post" action = "">
                                <table   id="tabla1">
                                    <tr>
                                        <td></td><td></td><td><input type = "image" id = "close_login" src = "./images/cerrarIco.png" width="50px" height="50px"></td>
                                    </tr>
                                </table><br><br>
                                
                                <table  id="tabla2">
                                    <tr >
                                        <td colspan="3"><p><h3>ACCESO A USUARIOS</h3></p></td>
                                    </tr>
                                    <tr>
                                        <td colspan="3"><input type = "text" id = "login" placeholder = "Email Id" name = "uid"></td>
                                    </tr>
                                    <tr>
                                        <td colspan="3"><input type = "password" id = "password" name = "upass" placeholder = "***"></td>
                                    </tr>
                                    <tr>
                                        <td colspan="3"><input type = "submit" id = "dologin" value = "Entrar"></td>
                                    </tr>
			...
			<div class="hero">
				<ul class="slides">
					<li data-bg-image="images/slider-1@2x.jpg">
						<div class="container">
